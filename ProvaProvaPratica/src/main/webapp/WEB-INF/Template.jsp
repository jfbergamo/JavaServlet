...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="App">Add</a>
					</li>
					<li class="nav-item">
						<button class="nav-link active" aria-current="page" id="logout">Logout</button>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="App?page=checkout">Checkout</a>
					</li>
					<li class="nav-item">
	...
	<jsp:include page="shared/modalLogout.jsp"></jsp:include>
</body>
</html>